...
export const translations = {
    ...
    yieldRentLabel: "Kuukausivuokra (Terassitalo)",
    ...
    // Executive Housing -osio
    ehBadge: "Executive Housing",
    ehTitle: "Majoituspalvelut projektitiimillesi",
    ehSub: "Kolme kohdetta Kokkolan ytimessä — jousta tiimin koon ja keston mukaan.",
    ehCapacityLabel: "Kapasiteetti",
    ehNightLabel: "€/yö",
    ehVatNote: "Asuinmajoitus ALV 0 %",
    ehCoworkingVatNote: "Coworking ALV 25,5 %",
    ehExternalNote: "Kumppanin kohde — saatavuus vaihtelee",
    ehLinkLabel: "Lisätietoja →",
    ehHeadlineOnlyNote: "Yksityiskohdat pyydettäessä",
    ehPersonsUnit: "hlö",
    ehFeatEh1_1: "Kalustettu kaksio",
    ehFeatEh1_2: "Ydinkeskusta",
    ehFeatEh1_3: "Oma sisäänkäynti",
    ehVe2LiveWorkNote: "VE2-jaon jälkeen PK18:n asuinosa (94 m²) tuo majoituksen samaan rakennukseen Coworkingin kanssa — live + work samassa talossa.",
    // EH-laskuri
    ehCalcBadge: "Laske säästösi",
    ehCalcTitle: "Kustannusvertailu — Coworking + Executive Housing",
    ehCalcSub: "Syötä tiimin koko ja kesto. Laskuri allokoi majoituspaikat EH1→EH2 järjestyksessä ja vertaa hotellivaihtoehtoon.",
    ehCalcTeamLabel: "Tiimin koko",
    ehCalcTeamUnit: "hlö",
    ehCalcDurationLabel: "Kesto",
    ehCalcDurationDay: "1 vrk",
    ehCalcDurationThreeDays: "3 vrk",
    ehCalcDurationWeek: "Viikko (7 vrk)",
    ehCalcUseSeaside: "Merenrantakiinteistö (EH2)",
    ehCalcUseNeristan: "Neristan, kumppani (EH3)",
    ehCalcRowHotel: "Hotelliyöpyminen + kokous (vertailu)",
    ehCalcRowCoworking: "Coworking (Terassitalo)",
    ehCalcRowEh1: "Executive Housing 1 — PK33",
    ehCalcRowEh2: "Executive Housing 2 — Merenranta",
    ehCalcRowEh3: "Executive Housing 3 — Neristan (kumppani)",
    ehCalcRowOverflow: "Ylivuoto hotelliin",
    ehCalcRowTotal: "Paketti yhteensä",
    ehCalcRowSavings: "Säästö",
    ehCalcOversized: "Tähän tarpeeseen paketti on ylimitoitettu – harkitse pelkkää EH1-yötä tai Coworking-päivää.",
    ehCalcVatNote: "Coworking ALV 25,5 %. Majoitus ALV 0 %.",
    ehCalcCheaper: "halvempi",
    ehCalcBasisBundle: "Pakettihinta: Coworking + EH1 yhdistelmänä (1 vrk 550 €, 3 vrk 1 000 €, viikko 1 300 €)",
    ehCalcBasisHotel: "Hotelli: 120 €/yö/hlö + kokoustila 200 €/pv",
    ehCalcDuration1Month: "1 kk",
    ehCalcDuration3Months: "3 kk",
    ehCalcDuration6Months: "6 kk",
    ehCalcRowApartment: "Kalustettu asunto + toimisto (vertailu)",
    ehCalcBasisApartment: "Kuukausivuokrauksen vertailu: kalustettu yritysasunto ~1 400 €/kk + toimisto ~1 800 €/kk ≈ 3 200 €/kk",
    ehCalcEh3AutoNote: "EH3 aktivoitu automaattisesti — tiimin koko ≥ 15 hlö",
    ehCalcMonthlyNote: "Kuukausivuokrauksen vertailukohde on kalustettu asunto + toimisto, ei hotelli.",
    // VE2 tuottoarvio
    ve2YieldBadge: "VE2-jako — vuokratuottoarvio",
    ve2YieldSub: "Vireillä olevan VE2-ehdotuksen mukainen alustava arvio. Edellyttää päätöksiä — ei sitova.",
    ve2YieldCommercial: "Liiketila (n. 131 m²)",
    ve2YieldResidential: "Asuintila (n. 94 m²)",
    ve2YieldTarget: "Tavoite",
    ve2YieldRealistic: "Alustava arvio",
    ve2YieldTotal: "Yhteensä (tavoite)",
    ve2YieldTotalRealistic: "Yhteensä (alustava)",
    ve2YieldPerMonth: "/kk",
    ve2YieldNote: "VE2-ehdotus on vireillä eikä sitä ole hyväksytty. Luvut ovat alustavia arvioita eivätkä tuottolupauksia.",
  },
  ...
  sv: {
    ...
    yieldRentLabel: "Månadshyra (Terassitalo)",
    ...
    // Executive Housing -osio
    ehBadge: "Executive Housing",
    ehTitle: "Boende för ditt projektteam",
    ehSub: "Tre objekt i Karlebys kärna — flexibelt efter teamstorlek och varaktighet.",
    ehCapacityLabel: "Kapacitet",
    ehNightLabel: "€/natt",
    ehVatNote: "Bostadsboende moms 0 %",
    ehCoworkingVatNote: "Coworking moms 25,5 %",
    ehExternalNote: "Partnerobjekt — tillgänglighet varierar",
    ehLinkLabel: "Mer information →",
    ehHeadlineOnlyNote: "Detaljer på begäran",
    ehPersonsUnit: "pers",
    ehFeatEh1_1: "Möblerad tvårumslägenhet",
    ehFeatEh1_2: "Stadskärna",
    ehFeatEh1_3: "Egen ingång",
    ehVe2LiveWorkNote: "Efter VE2-uppdelningen erbjuder PK18:s bostadsdel (94 m²) boende i samma byggnad som Coworking — live + work i samma hus.",
    // EH-laskuri
    ehCalcBadge: "Beräkna dina besparingar",
    ehCalcTitle: "Kostnadsjämförelse — Coworking + Executive Housing",
    ehCalcSub: "Ange teamstorlek och varaktighet. Kalkylatorn allokerar boenden EH1→EH2 i ordning och jämför med hotellalternativet.",
    ehCalcTeamLabel: "Teamstorlek",
    ehCalcTeamUnit: "pers",
    ehCalcDurationLabel: "Varaktighet",
    ehCalcDurationDay: "1 natt",
    ehCalcDurationThreeDays: "3 nätter",
    ehCalcDurationWeek: "Vecka (7 nätter)",
    ehCalcUseSeaside: "Havsstrandsfastigheten (EH2)",
    ehCalcUseNeristan: "Neristan, partner (EH3)",
    ehCalcRowHotel: "Hotellövernattning + konferens (jämförelse)",
    ehCalcRowCoworking: "Coworking (Terassitalo)",
    ehCalcRowEh1: "Executive Housing 1 — PK33",
    ehCalcRowEh2: "Executive Housing 2 — Havsstrand",
    ehCalcRowEh3: "Executive Housing 3 — Neristan (partner)",
    ehCalcRowOverflow: "Spill till hotell",
    ehCalcRowTotal: "Paket totalt",
    ehCalcRowSavings: "Besparing",
    ehCalcOversized: "För detta behov är paketet överdimensionerat – överväg enbart en EH1-natt eller en Coworking-dag.",
    ehCalcVatNote: "Coworking moms 25,5 %. Boende moms 0 %.",
    ehCalcCheaper: "billigare",
    ehCalcBasisBundle: "Paketpris: Coworking + EH1 som kombination (1 natt 550 €, 3 nätter 1 000 €, vecka 1 300 €)",
    ehCalcBasisHotel: "Hotell: 120 €/natt/pers + konferenslokal 200 €/dag",
    ehCalcDuration1Month: "1 mån",
    ehCalcDuration3Months: "3 mån",
    ehCalcDuration6Months: "6 mån",
    ehCalcRowApartment: "Möblerad bostad + kontor (jämförelse)",
    ehCalcBasisApartment: "Månadsuthyrning jämförelse: möblerad företagsbostad ~1 400 €/mån + kontor ~1 800 €/mån ≈ 3 200 €/mån",
    ehCalcEh3AutoNote: "EH3 aktiveras automatiskt — teamstorlek ≥ 15 pers",
    ehCalcMonthlyNote: "För månadsuthyrning jämförs mot möblerad bostad + kontor, inte hotell.",
    // VE2 tuottoarvio
    ve2YieldBadge: "VE2-uppdelning — hyresavkastningsuppskattning",
    ve2YieldSub: "Preliminär uppskattning enligt det pågående VE2-förslaget. Kräver beslut — ej bindande.",
    ve2YieldCommercial: "Affärslokal (ca 131 m²)",
    ve2YieldResidential: "Bostadslokal (ca 94 m²)",
    ve2YieldTarget: "Mål",
    ve2YieldRealistic: "Preliminär uppskattning",
    ve2YieldTotal: "Totalt (mål)",
    ve2YieldTotalRealistic: "Totalt (preliminärt)",
    ve2YieldPerMonth: "/mån",
    ve2YieldNote: "VE2-förslaget är under behandling och har inte godkänts. Siffrorna är preliminära uppskattningar och inte avkastningsgarantier.",
  },
  ...
  en: {
    ...
    yieldRentLabel: "Monthly rent (Terassitalo)",
    ...
    // Executive Housing section
    ehBadge: "Executive Housing",
    ehTitle: "Accommodation for your project team",
    ehSub: "Three properties in Kokkola's centre — scale to team size and duration.",
    ehCapacityLabel: "Capacity",
    ehNightLabel: "€/night",
    ehVatNote: "Residential accommodation VAT 0 %",
    ehCoworkingVatNote: "Coworking VAT 25.5 %",
    ehExternalNote: "Partner property — availability varies",
    ehLinkLabel: "More details →",
    ehHeadlineOnlyNote: "Details on request",
    ehPersonsUnit: "people",
    ehFeatEh1_1: "Furnished apartment",
    ehFeatEh1_2: "City centre",
    ehFeatEh1_3: "Private entrance",
    ehVe2LiveWorkNote: "After the VE2 split, PK18's residential section (94 m²) brings accommodation into the same building as the Coworking space — live + work under one roof.",
    // EH Calculator
    ehCalcBadge: "Calculate your savings",
    ehCalcTitle: "Cost Comparison — Coworking + Executive Housing",
    ehCalcSub: "Enter team size and duration. The calculator allocates accommodation EH1→EH2 in order and compares against the hotel alternative.",
    ehCalcTeamLabel: "Team size",
    ehCalcTeamUnit: "people",
    ehCalcDurationLabel: "Duration",
    ehCalcDurationDay: "1 night",
    ehCalcDurationThreeDays: "3 nights",
    ehCalcDurationWeek: "Week (7 nights)",
    ehCalcUseSeaside: "Seafront property (EH2)",
    ehCalcUseNeristan: "Neristan, partner (EH3)",
    ehCalcRowHotel: "Hotel accommodation + meeting room (comparison)",
    ehCalcRowCoworking: "Coworking (Terassitalo)",
    ehCalcRowEh1: "Executive Housing 1 — PK33",
    ehCalcRowEh2: "Executive Housing 2 — Seafront",
    ehCalcRowEh3: "Executive Housing 3 — Neristan (partner)",
    ehCalcRowOverflow: "Overflow to hotel",
    ehCalcRowTotal: "Package total",
    ehCalcRowSavings: "Savings",
    ehCalcOversized: "For this need, the package is oversized – consider a single EH1 night or a Coworking day instead.",
    ehCalcVatNote: "Coworking VAT 25.5 %. Accommodation VAT 0 %.",
    ehCalcCheaper: "cheaper",
    ehCalcBasisBundle: "Bundle price: Coworking + EH1 combined (1 night €550, 3 nights €1,000, week €1,300)",
    ehCalcBasisHotel: "Hotel: €120/night/person + meeting room €200/day",
    ehCalcDuration1Month: "1 month",
    ehCalcDuration3Months: "3 months",
    ehCalcDuration6Months: "6 months",
    ehCalcRowApartment: "Furnished apartment + office (comparison)",
    ehCalcBasisApartment: "Monthly rental comparison: furnished corporate apartment ~€1,400/mo + office ~€1,800/mo ≈ €3,200/mo",
    ehCalcEh3AutoNote: "EH3 activated automatically — team size ≥ 15 people",
    ehCalcMonthlyNote: "For monthly rental, comparison is furnished apartment + office, not hotel.",
    // VE2 yield estimate
    ve2YieldBadge: "VE2 split — rental yield estimate",
    ve2YieldSub: "Preliminary estimate based on the pending VE2 proposal. Subject to approvals — non-binding.",
    ve2YieldCommercial: "Commercial space (approx. 131 m²)",
    ve2YieldResidential: "Residential space (approx. 94 m²)",
    ve2YieldTarget: "Target",
    ve2YieldRealistic: "Preliminary estimate",
    ve2YieldTotal: "Total (target)",
    ve2YieldTotalRealistic: "Total (preliminary)",
    ve2YieldPerMonth: "/mo",
    ve2YieldNote: "The VE2 proposal is pending and has not been approved. Figures are preliminary estimates and not return guarantees.",
  },
} as const;
